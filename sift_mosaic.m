function  [matches,scores,f1,f2]=sift_mosaic(im1, im2,im3,im4)
...
imagesc([padarray(im3,dh1,'post') padarray(im4,dh2,'post')]) ;
o = size(im1,2) ;
...
hold on;
 ...
 for i=1:numMatches
   ...
   plot(f1(1,matches(1,i)),f1(2,matches(1,i)),'o')
   plot(f2(1,matches(2,i))+o,f2(2,matches(2,i)),'ro')
    hold on;
end
...
line([f1(1,matches(1,ok));f2(1,matches(2,ok))+o], ...
 ...
 hold on;
   ...
   plot(f1(1,matches(1,ok)),f1(2,matches(1,ok)),'o');
   hold on;
   plot(f2(1,matches(2,ok))+o,f2(2,matches(2,ok)),'ro');
   hold on;
